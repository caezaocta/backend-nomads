                            ...
                            <div class="member mt-3">
                                ...
                                <form action="{{ route('checkout-create', $item->id) }}" class="form-inline"
                                    ...
                                    <input type="text" class="form-control mb-2 mr-sm-2" id="nationality" required
                                        name="nationality" placeholder="Nationality" style="width: 50px">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        <input type="date" class="form-control" id="doe_passport" name="doe_passport"
                                            required placeholder="DOE Passport" />
